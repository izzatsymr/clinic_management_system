...
<div class="flex flex-wrap">
    ...
    <x-inputs.group class="w-full">
        <x-inputs.text
            name="contact_no"
            label="Contact No"
            :value="old('contact_no', ($editing ? $user->contact_no : ''))"
            maxlength="255"
    ...
    <x-inputs.group class="w-full">
        <x-inputs.text
            ...
            :value="old('specialization', ($editing ? $user->specialization : ''))"
            maxlength="255"
    ...
    <x-inputs.group class="w-full">
        <x-inputs.date
            name="schedule"
            label="Schedule"
            value="{{ old('schedule', ($editing ? optional($user->schedule)->format('Y-m-d') : '')) }}"
            max="255"
            required
        ></x-inputs.date>
    </x-inputs.group>
